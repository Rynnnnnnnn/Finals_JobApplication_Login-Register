...
<table>
    ...
    <tbody>
        <tr>
            <td><?= $applicants['metadata']['last_added_by'] ?? 'N/A' ?></td>
            <td><?= $applicants['metadata']['date_added'] ?? 'N/A' ?></td>
            <td><?= $applicants['metadata']['last_updated'] ?? 'N/A' ?></td>
            <td><?= $applicants['metadata']['last_updated_by'] ?? 'N/A' ?></td>
        </tr>
    </tbody>
</table>
